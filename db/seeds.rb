...
category = Category.create!(name: 'House Rent', icon: 'house')
10.times do
  expense = Expense.new(name: Faker::Address.street_address, amount: rand(0.5..10.0), author: user, category_ids: [category.id])
  expense.save!
end
